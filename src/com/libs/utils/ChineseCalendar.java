...
/**
 * interface:
 *   static String SolarToLunar(long millis, int flag);
 * parameters:
 *   millis: milliseconds
 *   flag: specify return string format, can be one of the following flags:
 *       YYYYMMDD: YearMonthDay(eg:20100530)
 *       YYYYMM:   YearMonth(eg:201005)
 *       MMDD:     Month(eg:0530)
 *
 * Other usage:
 *   SolarDate sdate = new SolarDate(2010,5,30);
 *   LunarDate ndate = sdate.toLunarDate();
...
public class ChineseCalendar {
    ...
    public static final int MMDD = 2; 
    public static String SolarToLunar(long millis, int flag)
    {
//        Time t = new Time();
//        t.set(millis);
//        String r = sCalendarSolarToLundar(t.year, t.month + 1, t.monthDay);
        Calendar c = Calendar.getInstance();
        String r = sCalendarSolarToLundar(
                c.get(Calendar.YEAR), 
